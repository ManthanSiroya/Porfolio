...
function __OriginkitBase_CurvedLoop({
    text = "Originkit",
    font = {
        fontFamily: "Inter",
        fontWeight: 400,
...
export default function CurvedLoop(props: Record<string, unknown>) {
  return <__OriginkitBase_CurvedLoop {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
